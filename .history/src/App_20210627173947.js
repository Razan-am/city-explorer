...
class App extends Component {
  ...
  handlerSubmit =async (e)=>{
    ...
    let mapResponed = await axios.get(`https://maps.locationiq.com/v3/staticmap?key=key=pk.0a80fd547a3c1e8574e39921b81514c5&center=${this.state.latitude},${this.state.longitude}&zoom=`)
    this.setState({
