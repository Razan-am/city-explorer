...
class App extends Component {
  ...
  render() {
    return (
      <div>
        <form onSubmit={this.handlerSubmit} style={{marginLeft: '100px',paddingTop:'20px',display:'inlineBlock',width:'100px'}}>
          <input type='text' placeholder='City Name' onChange={(e)=>{this.handlerData(e)}}/>
          <button style={{marginLeft: '200px',display:'inlineBlock',width:'100px'}}>Explorer!</button>
        </form>
